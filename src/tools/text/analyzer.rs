...
impl Tool for TextAnalyzer {
    ...
    fn ui(&mut self, ui: &mut egui::Ui) {
        ...
        let col_gap = 12.0;
        let left_w = ((panel_w - col_gap) * 0.58).max(200.0);
        let right_w = (panel_w - col_gap - left_w).max(160.0);
        ...
        ui.horizontal(|ui| {
            ...
            ui.allocate_ui_with_layout(
                ...
                |ui| {
                    ...
                    ui.add_space(io_layout::ROW_GAP);
                    let text_h = ui.available_height().max(40.0);
                    ui.allocate_ui_with_layout(
            ...
            // --- Right: stats + actions ---
            let stats_h = (panel_h * 0.42).max(140.0);
            let actions_h = (panel_h - stats_h - io_layout::ROW_GAP).max(100.0);
            ui.allocate_ui_with_layout(
                ...
                |ui| {
                    ...
                    ui.allocate_ui_with_layout(
                        ...
                        |ui| {
                            ui.set_width(right_w);
                            ui.set_max_width(right_w);
                            ui.set_height(stats_h);
                            ui.set_max_height(stats_h);
                            ...
                            egui::ScrollArea::vertical()
                                ...
                                .show(ui, |ui| {
                                    ui.set_width(right_w);
                                    let sel_stats =
                                        compute_selection_stats(ui, "analyzer_input", &self.input);
                    // Selection stats
                    ...
                    ui.allocate_ui_with_layout(
                        ...
                        |ui| {
                            ui.set_width(right_w);
                            ui.set_max_width(right_w);
                            ui.set_height(actions_h);
                            ui.set_max_height(actions_h);
                            egui::ScrollArea::vertical()
